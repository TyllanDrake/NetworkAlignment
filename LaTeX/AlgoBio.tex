...
\begin{small}\textit{\textbf{Figura 8.1}: Confronto di struc2vec con due algoritmi allo stato dell'arte; il metodo eccelle nell'individuazione di structural identity fra nodi}.\end{small}
\end{center}
